...
void createCube()
{
	...
	GLfloat cube_textures[] = { 0.75, 0.67,  // v0,v1,v2,v3 (front)
							   0.5, 0.67,
							   0.5, 0.33,
							   0.75, 0.33,


							   0.75, 0.67,  // v0,v3,v4,v5 (right)
							   0.75, 0.33,
							   1.0, 0.33,
							   1.0, 0.67,


								0.75, 0.67,  // v0,v5,v6,v1 (top)
								0.75, 1.0,
							    0.5, 1.0,
							    0.5, 0.67,

							   0.5, 0.67, // v1,v6,v7,v2 (left)
							   0.25, 0.67,
							   0.25, 0.33,
							   0.5, 0.33,

							   0.5, 0.0,// v7,v4,v3,v2 (bottom)
							   0.75, 0.0,
							   0.75, 0.33,
							   0.5, 0.33,

							   0.25, 0.33,// v4,v7,v6,v5 (back)
							   0.0, 0.33,
							   0.0, 0.67,
							   0.25, 0.67 };
